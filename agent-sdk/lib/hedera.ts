 ...
 */
export function initEVM(): { provider: ethers.providers.JsonRpcProvider; wallet: ethers.Wallet | null } {
 ...
 */
export function initHCS(): Client {
 ...
 */
export function getContract(address: string, abi: any[], privateKey?: string): ethers.Contract {
  if (privateKey) {
 ...
 */
export async function createEscrow(escrowManagerAddr: string, escrowId: string, freelancerAddr: string): Promise<ethers.ContractReceipt> {
  const abi = [
 ...
 */
export async function fundEscrow(escrowManagerAddr: string, escrowId: string, amountHBAR: string): Promise<ethers.ContractReceipt> {
 ...
 */
export async function submitHCSMessage(topicId: string, message: string): Promise<any> {
 ...
 */
export async function checkEscrowPaid(escrowManagerAddr: string, escrowId: string): Promise<boolean> {
  const abi = [
